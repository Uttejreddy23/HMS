...
// import 'package:hms/screens/auth/universal_register.dart';
...
//                                 Navigator.push(
//                     context,
//                     MaterialPageRoute(builder: (_) => UniversalRegisterPage()),
//                   );
              ...
              children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Padding(
                          padding: EdgeInsets.symmetric(horizontal: 40),
                          child: Text(
                            "Futuristic hospital management for AI diagnostics, telemedicine, and smart healthcare.",
                            textAlign: TextAlign.center,
                            style:
                                TextStyle(fontSize: 16, color: Colors.white70),
                          ),
                ...
                _AnimatedSection(
                  ...
                  child: _SectionContainer(
                    ...
                    title: "About SmartKare",
                    content:
                        "SmartKare is a next-generation hospital management system powered by AI and analytics. "
                        "We simplify patient management, appointment scheduling, and digital health tracking.",
                  ),
                ),
                ...
                Container(
                  ...
                  child: const Center(
                    child: Text(
                      "© 2025 SmartKare | Designed by Chandana",
                      style: TextStyle(color: Colors.white70, fontSize: 14),
                    ),
                  ),
                ),
...
class FeatureGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final features = [
      {"icon": Icons.calendar_month, "title": "Online Appointment"},
      {"icon": Icons.local_hospital_rounded, "title": "Hospital Management"},
      {"icon": Icons.video_call_rounded, "title": "Telemedicine"},
      {"icon": Icons.shield_rounded, "title": "Secure Records"},
      {"icon": Icons.science_rounded, "title": "AI Diagnosis"},
      {"icon": Icons.analytics_rounded, "title": "Health Analytics"},
    ];
